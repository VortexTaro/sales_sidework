...
const HeroSection = () => (
  <section className="w-full bg-gray-900 text-white">
    <div className="container mx-auto flex flex-col items-center justify-center h-screen min-h-[700px] text-center px-4">
      ...
      <p className="text-lg md:text-xl mb-8">
        【年収550万円以上の方、限定募集】<br />
        アポ獲得・クライアント探し一切不要、ZOOMで商談するだけの副業に挑戦しませんか？
      </p>
      <a
        href="#entry"
    ...
    <section id="problems" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <ProblemCard title="現役営業・ISの方へ" problems={problemsForSales} />
          <ProblemCard title="非営業職の方へ" problems={problemsForNonSales} />
          <ProblemCard title="将来独立を考える方へ" problems={problemsForFuture} />
        </div>
      </div>
    </section>
  );
  ...
  <section id="reasons" className="py-20 bg-white">
    <div className="container mx-auto px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mt-2">
          なぜ、この副業が“選ばれたビジネスパーソン”に支持されるのか？
        </p>
      </div>
      <div className="grid md:grid-cols-3 gap-8">
        <ReasonCard
          ...
          title="完全リモート & 身バレ防止"
        >
          副業禁止の企業でも専門家指導のもと、会社に知られずに始められます。もちろん商談は自宅からでOKです。
        </ReasonCard>
        <ReasonCard
          ...
          title="“おいしい商談”だけに集中"
        >
          最も大変な「アポ獲得」は本部が代行。あなたは質の高い高単価案件の商談にのみ、集中できます。
        </ReasonCard>
        <ReasonCard
          icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>}
          title="充実の教育体制"
        >
          専任マネージャーが伴走し、トップセールスの技術を完全インストール。再現性の高いトークスクリプトも完備。
        </ReasonCard>
      </div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div className="bg-gray-50 p-8 rounded-lg shadow-md">
          ...
          <p className="text-right mt-6 font-bold text-gray-700">– Kさん（31歳）/ 上場企業 人事担当</p>
        </div>
        <div className="bg-gray-50 p-8 rounded-lg shadow-md">
          ...
          <p className="text-right mt-6 font-bold text-gray-700">– Nさん（28歳）/ メーカー勤務</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="requirements" className="py-20 bg-white">
    <div className="container mx-auto px-4 max-w-3xl">
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
        <p className="font-semibold text-gray-800 mb-4">私たちは、本気の方とだけ、パートナーシップを組みたいと考えています。</p>
...
const CtaSection = () => (
  <section id="entry" className="py-20 bg-gray-900 text-white">
    <div className="container mx-auto px-4 text-center">
      ...
      <p className="max-w-2xl mx-auto mb-8">あなたの5年後には、2つの未来しかありません。「会社に依存せず、自分の力で稼ぐスキル」を手に入れた未来か、何も変わらず、会社の昇給をただ待つ未来か。</p>
      <a
